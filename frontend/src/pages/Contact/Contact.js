...
import contactUsImage from "../../assets/Contact us-rafiki.png";
...
export default function ContactUs({data}) 
{
  ...
  function handleSubmit(e){
    ...
    if (firstNameError || lastNameError || emailError || phoneNumberError || messageError){
      ...
      axios.post(BASE_URL+'/utility/contact',{firstname:firstName,lastname:lastName,email:email,phone:phoneNumber,message:message}).then((response)=>{
  ...
  const gettoken = () => {
    axios.get(BASE_URL+"/auth/csrf-token", {withCredentials: true}).then((res) => {
    ...
    <div className={Styles["contactus-container"]}>
        <div className={Styles["contactus-left"]}>
            ...
            <div className={Styles["contactus-links"]}>
                <p className={Styles["single-link"]}><i className="fa-solid fa-location-crosshairs"></i>ABC University</p>
                <p className={Styles["single-link"]}><i className="fa-solid fa-phone"></i>+91 1234567890</p>
                <p className={Styles["single-link"]}><i className="fa-solid fa-envelope"></i> contactcoderarena2003@gmail.com</p>
